/** Same as the below mentioned package but with minor customisations, left the comments for credit 
  ...
  unix: function(entry) {
    ...
    if (group) {
      ...
      if (group[20].indexOf(":") === -1) {
        ...
        date = new Date(group[19] + " " + group[20]);
      }
